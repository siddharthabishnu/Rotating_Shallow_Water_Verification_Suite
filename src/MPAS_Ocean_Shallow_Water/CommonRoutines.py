...
def ComputeRelativeError(ExactSolution,NumericalSolution):
    if ExactSolution == 0.0 and NumericalSolution == 0.0:
        RelativeError = 0.0
    elif ((ExactSolution == 0.0 and NumericalSolution != 0.0) or (NumericalSolution == 0.0 and ExactSolution != 0.0)):
        RelativeError = 1.0
    else:
        RelativeError = abs((NumericalSolution - ExactSolution)/ExactSolution)
