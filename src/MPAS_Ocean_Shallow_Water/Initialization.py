...
def SpecifyMeshDirectoryAndMeshFileNames(ProblemType,ProblemType_EquatorialWave,ReturnOnlyMeshDirectory=False):
    if ProblemType == 'Plane_Gaussian_Wave':
        ...
        MeshDirectory = '../../meshes/MPAS_Ocean_Shallow_Water_Meshes/PlanetaryRossbyWaveMesh'
...
def SpecifyNumberOfTimeSteps(ProblemType,ProblemType_EquatorialWave,ProblemType_NoExactSolution):
    if ProblemType == 'Plane_Gaussian_Wave':
        nTime_Minimum = 433 + 1
        nTime = 436 + 1
    elif ProblemType == 'Coastal_Kelvin_Wave' or ProblemType_EquatorialWave:
...
class NameList:
    ...
    def __init__(myNameList,ProblemType,PrintPhaseSpeedOfWaveModes,PrintAmplitudesOfWaveModes,TimeIntegrator,
        ...
        myNameList.nDumpFrequency = SpecifyDumpFrequency(ProblemType,myNameList.ProblemType_EquatorialWave,
                                                         myNameList.ProblemType_NoExactSolution)
        ...
        SpecifyNumberOfTimeSteps(ProblemType,myNameList.ProblemType_EquatorialWave,
                                 myNameList.ProblemType_NoExactSolution))
